...
class Container_f886136290 extends _PHPStan_772f29794\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_f886136290 $container)
			{
	...
	public function createServiceContainer(): Container_f886136290
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 5,
			'paths' => ['/Users/mikael/code/nova-time-field/src', '/Users/mikael/code/nova-time-field/config'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'env' => [
				...
				'XDEBUG_HANDLER_SETTINGS' => '/private/var/folders/kc/kxb5r2cx7j34t3n2r155lbg80000gn/T/GGZO24|1|*|*|/opt/homebrew/etc/php/8.3/php.ini:/opt/homebrew/etc/php/8.3/conf.d/error_log.ini:/opt/homebrew/etc/php/8.3/conf.d/ext-opcache.ini:/opt/homebrew/etc/php/8.3/conf.d/php-memory-limits.ini|3.3.2',
				...
				'PHP_INI_SCAN_DIR' => '',
				'PHPRC' => '/private/var/folders/kc/kxb5r2cx7j34t3n2r155lbg80000gn/T/GGZO24',
			],
		];
	}
