...
class Container_ea43067808 extends _PHPStan_772f29794\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_ea43067808 $container)
			{
	...
	public function createServiceContainer(): Container_ea43067808
	{
		return $this;
	}
